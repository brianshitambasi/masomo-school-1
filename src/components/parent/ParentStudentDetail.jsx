...
const ParentStudentDetail = () => {
  ...
  // ✅ FIXED: Added fetchStudentData as dependency
  useEffect(() => {
    if (id) {
      fetchStudentData();
    }
    ...
    <div className="container mt-4">
      ...
      <nav aria-label="breadcrumb" className="mb-3">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item fw-bold">
            <Link to="/parent-dashboard/children">Children</Link>
          </li>
        ...
        <div className="col-lg-8">
          <div className="card p-4 shadow-sm mb-4">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <label className="text-muted small">Admission Number</label>
              ...
              <div className="col-md-6">
                ...
                <p className="fw-semibold">{student.dateOfBirth ? new Date(student.dateOfBirth).toLocaleDateString() : 'N/A'}</p>
              </div>
              <div className="col-md-6">
                <label className="text-muted small">Classroom</label>
          ...
          {attendanceSummary && (
            <div className="card p-4 shadow-sm mb-4">
              ...
              <div className="row g-2">
                <div className="col-3">
                  <div className="bg-success text-white text-center p-2 rounded">
                    <h6 className="mb-0">{attendanceSummary.present || 0}</h6>
                    <small>Present</small>
                  </div>
                </div>
                <div className="col-3">
                  <div className="bg-danger text-white text-center p-2 rounded">
                    <h6 className="mb-0">{attendanceSummary.absent || 0}</h6>
                    <small>Absent</small>
                  </div>
                </div>
                <div className="col-3">
                  <div className="bg-warning text-dark text-center p-2 rounded">
                    <h6 className="mb-0">{attendanceSummary.late || 0}</h6>
                    <small>Late</small>
                  </div>
                </div>
                <div className="col-3">
                  <div className="bg-info text-white text-center p-2 rounded">
                    <h6 className="mb-0">{attendanceSummary.percentage || 0}%</h6>
                    <small>Rate</small>
                  </div>
                </div>
              </div>
              ...
              <div className="row g-2">
                <div className="col-4">
                  <div className="bg-primary text-white text-center p-2 rounded">
                    <h6 className="mb-0">{gradesSummary.average || 0}%</h6>
                    <small>Average</small>
                  </div>
                </div>
                <div className="col-4">
                  <div className="bg-success text-white text-center p-2 rounded">
                    <h6 className="mb-0">{gradesSummary.highest || 0}</h6>
                    <small>Highest</small>
                  </div>
                </div>
                <div className="col-4">
                  <div className="bg-danger text-white text-center p-2 rounded">
                    <h6 className="mb-0">{gradesSummary.lowest || 0}</h6>
                    <small>Lowest</small>
                  </div>
                </div>
              </div>
